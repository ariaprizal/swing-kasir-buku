...
public class loginkasir extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        stat = DB.stm;
        try {
            sql = "SELECT * FROM loginkasir WHERE id='"+nip.getText()+"'";
            rs = stat.executeQuery(sql);
            if(rs.next()){ 
                if(pass.getText().equals(rs.getString("password"))){
                    menukasir menu=new menukasir();
                    menu.user.setText(rs.getString("nama"));
                    ...
                    JOptionPane.showMessageDialog(null, "NIP Anda Tidak Ditemukan     !!!");
                    nip.setText("");
                    pass.setText("");
                    nip.requestFocus();
                }
